package org.bitbucket.unclebearbot.codingpuzzles.codility.lesson00202;
...
public class Solution {
    ...
    public static void test(Solution solution) {
        ...
        Assertion.equalObjects(solution.solution(new int[]{1, 2, 1}), 2);
        Assertion.equalObjects(solution.solution(new int[]{1, 1, 1, 1, 1}), 1);
        Assertion.equalObjects(solution.solution(new int[]{1, 2, 1, 2, 1, 2, 1, 2, 1}), 1);
    }
}
